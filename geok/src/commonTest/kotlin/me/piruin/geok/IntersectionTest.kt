...
class IntersectionTest {
    ...
    fun intersectionPoint() {
        ...
        line1 segmentIntersectionWith line2 shouldBeEqualTo (LatLng(1 to 1) to LatLng(1 to 1))
        line1 segmentIntersectionWith line3 shouldBeEqualTo (LatLng(1 to 1) to LatLng(1 to 1))
        line1 segmentIntersectionWith line4 shouldBeEqualTo (LatLng(1 to 1) to LatLng(1 to 1))
        line3 segmentIntersectionWith line4 shouldBeEqualTo (LatLng(1 to 1) to LatLng(1 to 1))
    }
    ...
    fun intersectionPointNew() {
        ...
        line1.intersectionWith(line2).first shouldBeEqualTo LatLng(1 to 1)
        line1.intersectionWith(line3).first shouldBeEqualTo LatLng(1 to 1)
        line1.intersectionWith(line4).first shouldBeEqualTo LatLng(1 to 1)
        line2.intersectionWith(line3).first shouldBeEqualTo LatLng(1 to 1)
        line2.intersectionWith(line4).first shouldBeEqualTo LatLng(1 to 1)
        line3.intersectionWith(line4).first shouldBeEqualTo LatLng(1 to 1)
    }
    ...
    fun intersectionPointOfParallel() {
        ...
        line1 segmentIntersectionWith line2 shouldBe null
    }
    ...
    fun lineIntersectionPointsWithPolygon() {
        ...
        line intersectionsWith boundary shouldBeEqualTo expected
    }
    ...
    fun intersectionPointPolygon() {
        ...
        polygon1 intersectionsWith polygon2 shouldBeEqualTo listOf(
            LatLng(2 to 1),
            LatLng(3 to 1.9),
            LatLng(3.9 to 1),
            LatLng(3 to 0.1),
